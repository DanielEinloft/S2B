...
Defines all servers operations executed by http requests
*/
            ...
            else
            {
                ...
                switch(result)
                {
                    ...
                    default: //operation completed! :D
                            res.status(201).json(newGame); //utilizar para a pagina do user -> usar id p/ abrir pg user
                            break;
                }
            }
            ...
            else
            {
                ...
                switch(result)
                {
                    ...
                    case -1: //unexpected error
                            ...
                            break;
                    case 0: //operation completed! :D
                            res.status(201).json(newUserStore);
                            break;
                    default: //unexpected error
                            res.status(500).send('-1');
                            break;
